...
// const float heartRateMultiplier = 0.23; // Multiplication factor for heart rate calculation
// void setup() {
//   Serial.begin(115200);
...
// void loop() {
//  // Take samples every sampleTime_ms milliseconds
...
//     // Read IR and Red sensor values
//     irValue = particleSensor.getIR();
//     redValue = particleSensor.getRed();
    
//     // Calculate heart rate from IR sensor values
//     float avgValue = 0;
...
//     heartRate = 60000 / heartBeat * heartRateMultiplier; // Adjusted multiplication factor
    
//     // Output the heart rate
    
//     // Check if heartbeat is detected and activate buzzer
//     if (heartRate > heartbeatThreshold||heartRate<heartbeatmin) {
